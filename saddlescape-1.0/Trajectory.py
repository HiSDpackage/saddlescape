...
def DrawSearchTrajectory(instance, **kwargs):
	...
	if instance.Dim > 2 or callable(kwargs["Projection"]):
		if callable(kwargs["Projection"]) and instance.Dim == 2:
			print(
		...
		if kwargs["Projection"] is None or not callable(kwargs["Projection"]):
			print(
